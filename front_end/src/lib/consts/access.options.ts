...
export const addressExemple = [
  { qd: "01", lt: "01", label: "Carlos Daniel - qd 01 - lt 01" },
  { qd: "01", lt: "02", label: "Ana Paula Ferreira - qd 01 - lt 02" },
  { qd: "01", lt: "03", label: "João Henrique Silva - qd 01 - lt 03" },
  { qd: "01", lt: "04", label: "Maria Eduarda Castro - qd 01 - lt 04" },
  { qd: "01", lt: "05", label: "Felipe Augusto Mendes - qd 01 - lt 05" },

  { qd: "02", lt: "01", label: "Bruna Carvalho - qd 02 - lt 01" },
  { qd: "02", lt: "02", label: "Gabriel Souza - qd 02 - lt 02" },
  { qd: "02", lt: "03", label: "Larissa Andrade - qd 02 - lt 03" },
  { qd: "02", lt: "04", label: "Ricardo Moreira - qd 02 - lt 04" },
  { qd: "02", lt: "05", label: "Fernanda Lopes - qd 02 - lt 05" },

  { qd: "03", lt: "01", label: "Thiago Martins - qd 03 - lt 01" },
  { qd: "03", lt: "02", label: "Patrícia Barbosa - qd 03 - lt 02" },
  { qd: "03", lt: "03", label: "Rafael Gonçalves - qd 03 - lt 03" },
  { qd: "03", lt: "04", label: "Juliana Figueiredo - qd 03 - lt 04" },
  { qd: "03", lt: "05", label: "Eduardo Santana - qd 03 - lt 05" },

  { qd: "04", lt: "01", label: "Marcela Tavares - qd 04 - lt 01" },
  { qd: "04", lt: "02", label: "André Ribeiro - qd 04 - lt 02" },
  { qd: "04", lt: "03", label: "Camila Duarte - qd 04 - lt 03" },
  { qd: "04", lt: "04", label: "Diego Monteiro - qd 04 - lt 04" },
  { qd: "04", lt: "05", label: "Isabela Rocha - qd 04 - lt 05" },

  { qd: "05", lt: "01", label: "Lucas Fernandes - qd 05 - lt 01" },
  { qd: "05", lt: "02", label: "Aline Nascimento - qd 05 - lt 02" },
  { qd: "05", lt: "03", label: "Matheus Correia - qd 05 - lt 03" },
  { qd: "05", lt: "04", label: "Renata Teixeira - qd 05 - lt 04" },
  { qd: "05", lt: "05", label: "Bruno Almeida - qd 05 - lt 05" },

  { qd: "06", lt: "01", label: "Letícia Moura - qd 06 - lt 01" },
  { qd: "06", lt: "02", label: "Paulo César Braga - qd 06 - lt 02" },
  { qd: "06", lt: "03", label: "Vanessa Meireles - qd 06 - lt 03" },
  { qd: "06", lt: "04", label: "Jorge Matos - qd 06 - lt 04" },
  { qd: "06", lt: "05", label: "Mariana Guedes - qd 06 - lt 05" },

  { qd: "07", lt: "01", label: "Renato Vasconcelos - qd 07 - lt 01" },
  { qd: "07", lt: "02", label: "Natália Pires - qd 07 - lt 02" },
  { qd: "07", lt: "03", label: "Alexandre Campos - qd 07 - lt 03" },
  { qd: "07", lt: "04", label: "Beatriz Antunes - qd 07 - lt 04" },
  { qd: "07", lt: "05", label: "Cláudio Aragão - qd 07 - lt 05" },

  { qd: "08", lt: "01", label: "Helena Mourão - qd 08 - lt 01" },
  { qd: "08", lt: "02", label: "Fábio Cardoso - qd 08 - lt 02" },
  { qd: "08", lt: "03", label: "Giovana Ribeiro - qd 08 - lt 03" },
  { qd: "08", lt: "04", label: "Marcelo Batista - qd 08 - lt 04" },
  { qd: "08", lt: "05", label: "Sabrina Costa - qd 08 - lt 05" },

  { qd: "09", lt: "01", label: "Henrique Dias - qd 09 - lt 01" },
  { qd: "09", lt: "02", label: "Carolina Assis - qd 09 - lt 02" },
  { qd: "09", lt: "03", label: "Victor Rezende - qd 09 - lt 03" },
  { qd: "09", lt: "04", label: "Tatiane Borges - qd 09 - lt 04" },
  { qd: "09", lt: "05", label: "Rodrigo Peixoto - qd 09 - lt 05" },

  { qd: "10", lt: "01", label: "Elisa Martins - qd 10 - lt 01" },
  { qd: "10", lt: "02", label: "Gustavo Aguiar - qd 10 - lt 02" },
  { qd: "10", lt: "03", label: "Priscila Freitas - qd 10 - lt 03" },
  { qd: "10", lt: "04", label: "Samuel Porto - qd 10 - lt 04" },
  { qd: "10", lt: "05", label: "Daniela Cunha - qd 10 - lt 05" }
];
